...
def create_split(directory, percentage):
    ...
    if os.path.exists(directory + f'/train10'):
        shutil.rmtree(directory + f'/train10')
    ...
    train_file = os.path.join(directory, 'meta', f'train10.txt')
    ...
    with open(train_file, "w") as trainfile:
        for i, line in tqdm.tqdm(enumerate(lines)):
            ...
            shutil.copy(os.path.join(directory, 'train', file), directory + f'/train10')
