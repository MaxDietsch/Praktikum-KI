...
def create_split(directory, percentage):
    ...
    if os.path.exists(directory + f'/train250'):
        shutil.rmtree(directory + f'/train250')
    os.mkdir(directory + f'/train250')
    ...
    train_file = os.path.join(directory, 'meta', f'train250.txt')
    ...
    with open(train_file, "w") as trainfile:
        for i, line in tqdm.tqdm(enumerate(lines)):
            ...
            shutil.copy(os.path.join(directory, 'train', file), directory + f'/train250')
            trainfile.write(line + '\n')


if __name__ == "__main__":
    directory = "../data_dir/SUN"
    percentage = 250/63490 #0.25
    create_split(directory, percentage)

    x = check_ratio("../data_dir/SUN/meta/train250.txt", 250)
